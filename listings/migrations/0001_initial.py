    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photos_main', cloudinary.models.CloudinaryField(max_length=255, verbose_name='listing')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', cloudinary.models.CloudinaryField(max_length=255, verbose_name='inside')),
